...
function buildChatSystemPrompt({
  ...
  return [
    ...
    '- "create_file" makes a new locale file from strings somebody dictates, with nothing',
    '  attached. Never ask for a placeholder document to be attached so that a file can be',
    '  created, and never say a file can only come from an upload.',
